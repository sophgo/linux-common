...
static struct snd_soc_dai_link_component cv181x_adc_cpus[] = {
	{
		.name = "29110000.i2s",
		.dai_name = "29110000.i2s",
	},
	{
		.name = "29150000.i2s",
		.dai_name = "29150000.i2s",
	},
...
static struct snd_soc_dai_link cv181x_adc_dai[] = {
	{
		...
		.cpus = &cv181x_adc_cpus[0],
		.num_cpus = 1,
		.codecs = &cv181x_adc_codecs[0],
		.num_codecs = 1,
		.platforms = &cv181x_adc_platform[0],
		.num_platforms = 1,
		.ops = &cv181x_adc_ops,
	...
	{
		.name = "cviteka-i2s-adc1",
		.stream_name = "cviteka-adc1",
		.cpus = &cv181x_adc_cpus[1],
		.num_cpus = 1,
		.codecs = &cv181x_adc_codecs[1],
		.num_codecs = 1,
		.platforms = &cv181x_adc_platform[1],
		.num_platforms = 1,
		.ops = &cv181x_adc_ops,
		.init = cv181x_adc_codec_init,
		.dai_fmt = SND_SOC_DAIFMT_I2S
...
static struct snd_soc_card cv181x_adc = {
	...
	.num_links = ARRAY_SIZE(cv181x_adc_dai),
