...
#define ARB_ID0 0x14      // This register holds data frame Identifier bits 2:0 of ID, RTR, DLC for normal frame and
						  //frame format, RTR, DLC for extended frame
#define ARB_ID1 0x15      // This register holds data frame Identifier bits 10:3 for normal frame and 28:21 for
						  //extended frame
...
#define RSP_ARB_ID0 0x19      // This register holds remote frame response Identifier bits 10:3 for normal frame and
							  // 28:21 for extended frame
#define RSP_ARB_ID1 0x1A      // This register holds remote frame response Identifier bits 2:0 for normal frame and
							  //20:13 for extended frame
...
#define TX_RSP_FIFO 0x20      // This is transmit response FIFO, data in this is read by transmitter, written by
							  // Firmware for remote frame request
