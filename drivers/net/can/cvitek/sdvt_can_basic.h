...
extern void write_byte_reg(u32 p_addr_32b, u8 p_data_8b);

// write_reg :#This is for register write
//            p_addr_32b :#Register address to write
//             p_data_8b :#Register data to write
extern void write_reg(u32 p_addr_32b, u8 p_data_8b);

// read_reg :#This is for register read
//               returns :#Return the read data
//            p_addr_32b :#Register address to read

extern u8  read_reg(u32 p_addr_32b);
...
//           p_config_st :# Pointer to config object
void send_command(struct sdvt_can_classdev *cdev,
...
void sdvt_mask_irq(struct sdvt_can_classdev *cdev,
				   struct sdvt_can_config *p_config_st,
				   u32 p_addr,
				   u8 p_mask_8b);
...
//           p_config_st :# Pointer to config object
//             p_mask_8b :# Interrupts to mask
void sdvt_unmask_irq(struct sdvt_can_classdev *cdev,
					 struct sdvt_can_config *p_config_st,
					 u32 p_addr,
					 u8 p_mask_8b);
