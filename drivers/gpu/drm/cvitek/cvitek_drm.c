...
DEFINE_DRM_GEM_DMA_FOPS(cvitek_drm_fops);
...
static struct drm_driver cvitek_drm_drv = {
	...
	/* GEM Operations */
	DRM_GEM_DMA_DRIVER_OPS_WITH_DUMB_CREATE(drm_cvitek_gem_dumb_create),
...
static void cvitek_drm_platform_remove(struct platform_device *pdev)
{
