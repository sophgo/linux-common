...
/* Compatibility macros for accessing struct cam_pll_s */
#define get_div_val(entry) ((entry).clk_div)
#define get_src_sel(entry) ((entry).sel_mode)
#define get_div_val_sel(entry) ((entry).post_div_sel)

#define GET_DIV_VAL(idx) get_div_val(cam_pll_setting[idx])
#define GET_SRC_SEL(idx) get_src_sel(cam_pll_setting[idx])
#define GET_DIV_VAL_SEL(idx) get_div_val_sel(cam_pll_setting[idx])
...
#if defined(CONFIG_COMMON_CLK_CVITEK)
static inline unsigned int get_cam_div_val(int idx) { return cam_pll_setting[idx].div_val; }
static inline unsigned int get_cam_src_sel(int idx) { return cam_pll_setting[idx].src_sel; }
static inline unsigned int get_cam_div_val_sel(int idx) { return cam_pll_setting[idx].div_val_sel; }
#else
static inline unsigned int get_cam_div_val(int idx) { return cam_pll_setting[idx].clk_div; }
static inline unsigned int get_cam_src_sel(int idx) { return cam_pll_setting[idx].sel_mode; }
static inline unsigned int get_cam_div_val_sel(int idx) { return cam_pll_setting[idx].post_div_sel; }
#endif
