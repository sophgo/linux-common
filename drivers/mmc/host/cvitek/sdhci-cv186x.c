...
static int cvi_proc_init(struct sdhci_cvi_host *cvi_host)
{
...
static int cvi_proc_shutdown(struct sdhci_cvi_host *cvi_host)
{
	pr_info("%s\n", __func__);
...
static void sdhci_cv186x_sd_voltage_switch(struct sdhci_host *host)
{
	uint32_t reg = 0;
	struct sdhci_pltfm_host *pltfm_host = sdhci_priv(host);
	struct sdhci_cvi_host *cvi_host = sdhci_pltfm_priv(pltfm_host);
...
static void sdhci_cv186x_sd1_voltage_switch(struct sdhci_host *host)
{
	uint32_t reg = 0;
	struct sdhci_pltfm_host *pltfm_host = sdhci_priv(host);
	struct sdhci_cvi_host *cvi_host = sdhci_pltfm_priv(pltfm_host);
...
static void sdhci_cv186x_sd_voltage_restore(struct sdhci_host *host, bool bunplug)
{
...
static void sdhci_cv186x_sd1_voltage_restore(struct sdhci_host *host, bool bunplug)
{
