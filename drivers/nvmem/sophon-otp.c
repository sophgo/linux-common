...
#else
static ssize_t otp3_reserve_segment2_show(const struct class *class,
...
#else
static ssize_t otp3_reserve_segment2_store(const struct class *class,
...
static ssize_t otp3_reserve_segment3_show(struct class *class,
					struct class_attribute *attr, char *buf)
#else
static ssize_t otp3_reserve_segment3_show(const struct class *class,
					const struct class_attribute *attr, char *buf)
#endif
{
	cvi_otp_power_switch(1);
...
static ssize_t otp3_reserve_segment3_store(struct class *class,
					...
					const char *buf, size_t count)
#else
static ssize_t otp3_reserve_segment3_store(const struct class *class,
					const struct class_attribute *attr,
					const char *buf, size_t count)
#endif
{
...
static ssize_t otp2_reserve_segment0_show(struct class *class,
					struct class_attribute *attr, char *buf)
#else
static ssize_t otp2_reserve_segment0_show(const struct class *class,
					const struct class_attribute *attr, char *buf)
#endif
{
	uint32_t value[32] = {0};
...
static ssize_t otp2_reserve_segment0_store(struct class *class,
					...
					const char *buf, size_t count)
#else
static ssize_t otp2_reserve_segment0_store(const struct class *class,
					const struct class_attribute *attr,
					const char *buf, size_t count)
#endif
{
...
#else
	otp_class = class_create(DEVICE_NAME);
#endif
	if (IS_ERR(otp_class)) {
...
#else
static void sophon_otp_remove(struct platform_device *pdev)
#endif
{
	class_remove_file(otp_class, &class_attr_otp2_reserve_segment0);
	class_remove_file(otp_class, &class_attr_otp3_reserve_segment2);
